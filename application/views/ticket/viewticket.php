    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default panel-shadow" data-collapsed="0"><!-- to apply shadow add class "panel-shadow" -->
            ...
            <div class="panel-heading">
                <div class="panel-title">Ticket #<?php echo $content[0]['ticket_id'] . " " . $content[0]['subject']; ?></div>
            </div>
    ...
    <section class="comments-env">
        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <textarea name="message" class="form-control autogrow" id="field-ta" placeholder="I will grow as you type new lines." required></textarea>
                <div class="col-sm-offset col-sm-2">
                    ...
                    <div class="radio">
                        <label>
                            <input type="radio" name="status" id="optionsRadios2" value="0">Closed
                        </label>
                    </div>
                </div>
            </div>
